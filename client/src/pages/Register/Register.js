...
export default function Register() {
  ...
  return (
    <div>
      ...
      <div className="register-background-functional">
        <div>
        ...
        <div className="div-user-register">
          ...
          <input className='login-user-register' type="text" placeholder="Ej: ramiro_diaz@darkroon.com" />
        </div>
        ...
        <div className="div-password-register">
        <label className='label-password-register'>Repetir contraseña</label>
          <input className='login-password-register' type="password" />
        <label className='label-check-password-register'>Mas de 6 caracteres</label>
        </div>
